...
{
    public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, IPauseHandler
    {
        ...
        protected virtual void Start()
        {
            ...
            baseRect.sizeDelta = new Vector2(Screen.width, Screen.height / 2.0f);
